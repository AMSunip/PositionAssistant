...
public class GpsManager
{
	...
	public static int getAlmanac(ArrayList<GpsSatellite> numSatelliteList)
	{
		int number = 0;
		
		for(int i=0;i<numSatelliteList.size();i++)
		{
			if(numSatelliteList.get(i).hasAlmanac())
			{
				number++;
			}
		}
	...
	public static int getEphemeris(ArrayList<GpsSatellite> numSatelliteList)
	{
		int number = 0;
		
		for(int i=0;i<numSatelliteList.size();i++)
		{
			if(numSatelliteList.get(i).hasEphemeris())
			{
				number++;
			}
		}
