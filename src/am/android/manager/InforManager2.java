...
public class InforManager2 
{
	public static void showInfor(Context context,String infor)
	{
		View view=((Activity) context).getLayoutInflater().inflate(R.layout.layout_toast2, null);
		Toast toast=new Toast(context);
		toast.setView(view);
		TextView tv_info=(TextView)view.findViewById(R.id.tv_infor2);
